...
/**
 * CustomAllureSelenide явлется копией класса AllureSelenide из библиотеки Selenide.
 * Используется для переопределения метода afterEvent, чтобы скриншоты снимались после каждого действия
 *
 * @author Selenide
 */
